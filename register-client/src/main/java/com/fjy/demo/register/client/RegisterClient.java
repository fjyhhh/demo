...
/**
 * 在服务上面被创建，主要用来跟register-server通信
 */
public class RegisterClient {
    ...
    public void start(){
        //一旦启动了这个组件之后：1、开启一个线程注册服务 2、注册成功之后，第二个线程用来发送心跳
        new RegisterClientWorker(serviceInstanceId).start();
    }
    /**
     * 用来发送注册申请,RegisterClientWorker，一般是一个内部类。因为RegisterClientWorker只有RegisterClient享有
     */
